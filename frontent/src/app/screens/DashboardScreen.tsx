...
export function DashboardScreen() {
  ...
  // Calculs depuis les données réelles de l'API
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-[360px] mx-auto px-6 -mt-4 space-y-3">
        ...
        {loading && (
          <div className="bg-white rounded-2xl shadow-md p-4 text-center text-gray-500 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-md p-5">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              {lowStock > 0 && (
                <p className="text-xs text-orange-500 mt-1">{lowStock} en stock faible</p>
              )}
            </div>
          </div>
        </div>

        {/* Carte saisie du soir */}
